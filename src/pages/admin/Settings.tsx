    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-slate-200 overflow-hidden shadow-sm mt-6">
        <form onSubmit={handleUpdatePassword} className="p-6 md:p-8 space-y-6">
          <div>
            <h3 className="text-lg font-bold text-slate-900 mb-4 border-b pb-2">Segurança da Conta</h3>
            <div className="max-w-md">
              ...
              <p className="text-xs text-slate-500 mt-2">
                A nova senha será aplicada imediatamente ao seu usuário.
              </p>
            </div>
          </div>
          ...
          <div className="flex justify-end pt-4 border-t border-slate-200">
            <button
              ...
              className="px-6 py-2 bg-slate-900 text-white rounded-lg hover:bg-slate-800 font-medium transition-colors flex items-center gap-2 disabled:opacity-50"
            >
              {updatingPassword ? (
                <div className="w-5 h-5 border-2 border-white border-t-transparent rounded-full animate-spin"></div>
              ) : (
